<x-header titletext="create package"/>
<style>
    .checkbox-size{
        width: 20px;
       height: 17px;
...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper text-end">
            <ol class="breadcrumbs">
                ...
                <li><span>Create Packages</span></li>
            </ol>
    ...
    <section class="card">
        ...
        <div class="col-lg-12">
            <form id="form1" class="form-horizontal" action="{{ '/save-package' }}" method="post">
                @csrf
                <section class="card">
                    <header class="card-header">
                       

                        <h2 class="card-title" style="text-align:center;">Create Package</h2>
                    </header>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea name="package_description" id="package_description" 
                                    class="form-control" maxlength="255">{{ old('package_description') }}</textarea>
                                <span class="text-danger">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-6">
                                <select name="package_type" id="package_type" class="form-control select">
                                    ...
                                    <option value="1" @if (old('package_type') == 1) selected @endif>Free
                                    </option>
                                    <option value="2" @if (old('package_type') == 2) selected @endif>Priemum
                                    </option>
                                </select>
                                <span class="text-danger">
                                    @error('package_type')
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                value="1" @if(old('tip_enabled')==1) checked @endif>
                            <label for="tip_enabled">Tips</label>
                            </div>
                            <div class=" col-sm-3 ">
                                <input type="checkbox" id="video" name="video_enabled" class="mx-2 checkbox-size"
                                value="1" @if(old('video_enabled')==1) checked @endif>
                            <label for="video_enabled">Videos</label>
                            </div>

                            <label class="col-sm-4 control-label text-sm-end pt-2 form-label select-label"></label>
                            <div class="col-sm-3">
                                <input type="checkbox" id="blog_enabled" name="blog_enabled" value="1" class="mx-2 checkbox-size"  @if(old('blog_enabled')==1) checked @endif>
                                <label for="blog_enabled">Blogs</label>
                            </div>
                            <div class=" col-sm-3 ">
                                <input type="checkbox" id="podcast_enabled" name="podcast_enabled" value="1" class="mx-2 checkbox-size" @if(old('podcast_enabled')==1) checked @endif>
                                <label for="podcast_enabled">Podcasts</label>
                            </div>
                            <label class="col-sm-4 control-label text-sm-end pt-2 form-label select-label"></label>
                            <div class="col-sm-3">
                                <input type="checkbox" id="movements_enabled" name="movements_enabled" value="1" class="mx-2 checkbox-size"  @if(old('movements_enabled')==1) checked @endif>
                                <label for="movements_enabled">Movements</label>
                            </div>
                            <div class=" col-sm-3 ">
                                <input type="checkbox" id="log_sharing_enabled" name="log_sharing_enabled"
                                value="1" class="mx-2 checkbox-size" @if(old('log_sharing_enabled')==1) checked @endif> 
                            <label for="log_sharing_enabled">Log Sharing</label>
                            </div>
                            <label class="col-sm-4 control-label text-sm-end pt-2 form-label select-label"></label>
                            <div class="col-sm-3">
                                <input type="checkbox" id="cycle_length_report_enabled"
                                name="cycle_length_report_enabled" value="1" class="mx-2 checkbox-size"  @if(old('cycle_length_report_enabled')==1) checked @endif>
                            ...
                            <div class=" col-sm-3 ">
                                ...
                                value="1" class="mx-2 checkbox-size"  @if(old('mood_report_enabled')==1) checked @endif>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="checkbox" id="energy_report_enabled" name="energy_report_enabled"
                                    value="1" class="mx-2 checkbox-size" @if(old('energy_report_enabled')==1) checked @endif>
                            ...
                            <div class=" col-sm-3 ">
                                ...
                                value="1" class="mx-2 checkbox-size " @if(old('general_report_enabled')==1) checked @endif>
...
{{-- 
                        <div class="form-group row my-2">
                            ...
                            <div class="col-sm-6">
                                <select name="package_expiry" id="package_expiry" class="form-control">
                                  ...
                                  @for($i=1;$i<=365;$i++)
                                  <option value="{{$i}}"  @if (old('package_expiry') == $i) selected @endif>{{$i}} Days</option>
                                  @endfor
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-sm-6">
                                <input type="number" name="package_expiry" id="package_expiry"  min="1" max="365"  value="10" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="status" class="form-control" >
                                    ...
                                    <option value="2" @if (old('status') == 2) selected @endif>In-active
                                    </option>
                                </select>
                                <span class="text-danger">
                                    @error('status')
