    ...
    <div class="col-lg-12 m-auto mb-2">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title" style="text-align:center;">List Coupons</h2>
...
<div class="table-responsive">
                <table class="table table-striped table-bordered table-responsive-md mb-0">
                   ...
                   <td style="text-align:center;" class="actions"><a href="/coupens/edit-coupons/{{$key->coupons_id}}" class="btn-sm btn-edit text-white mx-1">Edit</a>
                                        <a href="/coupens/delete-coupons/{{$key->coupons_id}}"  class="btn-sm btn-del text-white mx-1 my-1"
                                            onclick="return confirm('Do you really want to delete {{$key->name}}  this Coupons? ')">Delete</a>
