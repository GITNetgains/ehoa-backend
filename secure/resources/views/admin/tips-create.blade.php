...
<section role="main" class="content-body">
    ...
    <section class="card">
        ...
        <div class="col-lg-12">
            <form id="form1" class="form-horizontal" enctype="multipart/form-data" action="{{'/secure/secure/admin/save-tips'}}" method="post">
                @csrf
                ...
                <section class="card">
                    ...
                    <div class="form-group row pb-3">
                         ...
                         <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-6">
                                <select name="language_id" id="language_id" value="{{ old('language_id')}}" class="form-control select" >
                                    ...
                                    <option value="2" @if( old('language_id')==2) selected @endif>La temro</option>
                                </select>
                                <span class="text-danger">
                                    @error('language_id')
                                    {{$message}}
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-6">
                            <textarea type="text" name="description" id="description"  aria-describedby=""  class="form-control" placeholder="" accept="image/*">{{ old('description')}}</textarea>
                                <span class="text-danger">
                                    @error('description')
                                    {{$message}}
                                @enderror
 ...
 <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-6">
                                <select name="gender_id" id="gender_id" value="{{ old('gender_id')}}" class="form-control select" >
