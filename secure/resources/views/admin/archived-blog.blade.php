    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-end">
            <ol class="breadcrumbs">
                ...
                <li><span>Archived Blogs-List</span></li>
            </ol>
    ...
    <div class="col-lg-12 m-auto mb-2">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title"  style="text-align:center;">Archived Blogs List</h2>
                            ...
                            @if (count($blogs) > 0)
                                @foreach ($blogs as $blog)
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><a href="/undo-blog/{{ $blog->blog_id }}" class="btn-sm btn-edit text-white mx-1 my-1">Undo</a>
