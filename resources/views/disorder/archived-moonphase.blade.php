    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-end">
            <ol class="breadcrumbs">
                ...
                <li><span>Archived Moon Phase-List</span></li>
            </ol>
    ...
    <div class="col-lg-12 m-auto mb-2">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title" style="text-align:center;">Archived List Moon Phase</h2>
                            ...
                            @foreach ($moonphases as  $key)
                                <tr style="">
                                   ...
                                   <td>{{$key->moon_phases_name}}</td>
                                    ...
                                    <td style="text-align:center;" class="actions"><a href="/undo-moonphase/{{$key->moon_phase_id}}" class="btn-sm btn-edit text-white mx-1">Undo</a>
