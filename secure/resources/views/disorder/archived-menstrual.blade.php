    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-end">
            <ol class="breadcrumbs">
                ...
                <li><span>Archived Menstrual Flow  List</span></li>
            </ol>
    ...
    <div class="col-lg-12 m-auto mb-2">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title" style="text-align:center;">Archived Menstrual Flow List</h2>
                        ...
                        @if (count($mood_disorders) > 0)
                            @foreach ($mood_disorders as  $key)
                                <tr style="">
                                    ...
                                    <td style="text-align:center;" class="actions"><a href="/undo-menstrual/{{$key->disorders_id}}" class="btn-sm btn-edit text-white mx-1 my-1">Undo</a>
