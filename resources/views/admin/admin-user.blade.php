                    ...
                    <tbody>
                       ...
                       @if($user->register_type == 1)
                        <tr>
                            ...
                            <td class="actions">
                                <a  href="/admin/user-details/{{$user->user_id}}" class="btn-sm btn-view text-white mx-1 my-1 " >View</a>
                                <a href="/admin/edit-users/{{$user->user_id}}"  class="btn-sm btn-edit text-white mx-1 " >Edit</a>
                                <a href="/admin/delete-users/{{$user->user_id}}"  class="btn-sm btn-del text-white mx-1 my-1 "
                                    onclick="return confirm('Do you really want to delete {{$user->name}}  this User? ')">Delete</a>
