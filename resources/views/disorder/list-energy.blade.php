    ...
    <div class="col-lg-12 m-auto mb-2">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title" style="text-align:center;">List Energy </h2>
                    ...
                    <tbody>
                        ...
                        @if (count($mood_disorders) > 0)
                            @foreach ($mood_disorders as  $key)
                                ...
                                <a href="/disorder/delete-energy/{{$key->disorders_id }}"
                                    class="btn-sm btn-del text-white mx-1 my-1"
                                    onclick="confirm('Do you really want to delete {{$key->name}} this Energy? ')">Delete</a></td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
