    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-end">
            <ol class="breadcrumbs">
                ...
                <li><span>Archived list-Groups</span></li>
            </ol>
    ...
    <div class="col-lg-12 m-auto mb-2">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title" style="text-align:center;">Archived List Groups</h2>
            </header>
                        ...
                        <tr>
                          <td>{{$i++}}</td>
                            ...
                            <td class="actions" style="text-align:center;">
                                <a href="/undo-group/{{$group->g_id}}" class="btn-sm btn-edit text-white mx-1 ">Undo</a>
