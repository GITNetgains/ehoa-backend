                                    ...
                                    @foreach ($mydata as $data)
                                        ...
                                        if($data->type==6){
                                         ...
                                         ?>
                                            ...
                                            <td style="text-align:center;">@if($data->status==2)<span class="badge badge-dan text-danger  d-inline">In-Active</span> @endif @if($data->status==3)<span class="badge badge-dan text-danger  d-inline">Deleted</span> @endif @if($data->status==1) <span class="badge badge-suc text-success d-inline">Active</span> @endif</td>
                                            <td>
                                                {{$data->date}}
                                            </td>
                                            ...
                                            <td style="text-align:center;" class="">
                                                ...
                                                <a  href="{{'/undo-notification'}}/{{$data->push_notification_id}} "
