	...
	<section class="body">
		...
		<header class="header">
			...
			<div class="logo-container">
				...
				<a href="{{'/secure/admin/dashboard'}}" class="logo d-block d-sm-none">

					<img src="https://wahine.netgains.org/public/template/img/ehoa.png" width="85" height="55"
						alt=" Ehoa" />
						...
						<nav id="menu" class="nav-main" role="navigation">
							...
							<ul class="nav nav-main">
								...
								<li>
									...
									<a class="nav-link" href="{{'/secure/admin/dashboard'}}">
								...
								<li class="nav-parent {{ Route::is('package') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('package') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/package'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('package') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/list-all-packages'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('package') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/archived-package'}}">
								...
								<li class="nav-parent {{ Route::is('order') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('order') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/order/orders'}}">
								...
								<li class="nav-parent {{ Route::is('category') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('category') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/n-create-category'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('category') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/n-list-category'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('category') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/archived-category'}}">
								...
								<li class="nav-parent {{ Route::is('tip') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('tip') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/tips-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('tip') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/list-all-tips'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('tip') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/archived-tips'}}">
								...
								{{-- <li class="nav-parent">
									...
									<ul class="nav nav-children">
										...
										<li>
											...
											<a class="nav-link" href="{{'/secure/admin/yoga-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li>
											...
											<a class="nav-link" href="{{'/secure/admin/list-all-yogas'}}">
								...
								<li class="nav-parent {{ Route::is('video') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('video') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/videos-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('video') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/list-all-videos'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('video') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/archived-video'}}">
								...
								<li class="nav-parent {{ Route::is('podcast') ? 'nav-expanded' : '' }} ">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('podcast') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/podcast-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('podcast') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/list-all-podcast'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('podcast') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/archived-podcast'}}">
								...
								<li class="nav-parent  {{ Route::is('blog') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li {{ Route::is('blog') ? 'nav-active' : '' }}>
											...
											<a class="nav-link" href="{{'/secure/admin/create-blog'}}">
									...
									<ul class="nav nav-children">
										...
										<li {{ Route::is('blog') ? 'nav-active' : '' }}>
											...
											<a class="nav-link" href="{{'/secure/admin/get-list-blog'}}">
									...
									<ul class="nav nav-children">
										...
										<li {{ Route::is('blog') ? 'nav-active' : '' }}>
											...
											<a class="nav-link" href="{{'/secure/admin/archived-blog'}}">
								...
								<li class="nav-parent  {{ Route::is('menstrual') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('menstrual') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/menstrual-create/menstrual'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('menstrual') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/list-menstrual'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('menstrual') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/archived-menstrual'}}">
								...
								<li class="nav-parent {{ Route::is('symptoms') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('symptoms') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/symptoms-create/symptoms'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('symptoms') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/list-symtoms'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('symptoms') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/archived-symtoms'}}">
								...
								<li class="nav-parent {{ Route::is('emotions') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('emotions') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/emotions-create/emotions'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('emotions') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/list-emotions'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('emotions') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/archived'}}">
								...
								<li class="nav-parent {{ Route::is('energy') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('energy') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/energy-create/energy'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('energy') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/list-energy'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('energy') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/archived-energy'}}">
								...
								<li class="nav-parent {{ Route::is('moon') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('moon') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/moonphase-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('moon') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/list-all-moonphase'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('moon') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/disorder/archived-moonphase'}}">
								...
								<li class="nav-parent {{ Route::is('user') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('user') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/all-users-list'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('user') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/archived-user'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('user') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/groups/group-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('user') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/groups/list-all-groups'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('user') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/groups/archived-groups'}}">
									...
									<ul class="nav nav-children Admin-userss">
										...
										<li class="{{ Route::is('user') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/admin-user'}}">
										...
										<li class="{{ Route::is('user') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/admin/add-admin-user'}}">
								...
								<li class="nav-parent {{ Route::is('coupon') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('coupon') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/coupens/secure/coupens-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('coupon') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/coupens/list-all-coupons'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('coupon') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/coupens/archived-coupons'}}">
								...
								<li class="nav-parent {{ Route::is('notification') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('notification') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/notifications/push-notifications'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('notification') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/notifications/list-all-notifications'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('notification') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/notification/archived-notifi'}}">
								...
								<li class="nav-parent {{ Route::is('country') ? 'nav-expanded' : '' }} ">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('country') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/country/country-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('country') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/country/country-list'}}">
								...
								<li class="nav-parent {{ Route::is('language') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('language') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/language/language-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('language') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/language/language-list'}}">
								...
								<li class="nav-parent  {{ Route::is('editior') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('editior') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/editior/editior-create'}}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('editior') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/editior/list-editior'}}">
								...
								<li class="nav-parent  {{ Route::is('setting') ? 'nav-expanded' : '' }}">
									...
									<ul class="nav nav-children">
										...
										<li class="{{ Route::is('setting') ? 'nav-active' : '' }}">
											...
											<a class="nav-link" href="{{'/secure/setting/upload-setting'}}">
								...
								<li>
									...
									<a class="nav-link" href="{{'/secure/signout'}}">
