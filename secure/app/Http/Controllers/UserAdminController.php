...
// end of function
    ...
    // end
    // newly created 
    function getTips($energy_id,$sub_energy_id, $category_id)
    {
  ...
  // newly created function
    ...
    function showWisdomBlogs($category_id)
    {
        // dd($category_id);
        $data = DB::table('categories')
    ...
    function showWisdomPodcasts($category_id)
    {
        // dd($category_id);
        $data = DB::table('categories')
            ->leftJoin('podcasts', 'categories.category_id', '=', 'podcasts.subcategory_id')
            ->where('categories.category_id', $category_id)
            ->where('categories.status', 1)
    ...
    function showWisdomVideos($category_id)
    {
        // dd($category_id);
        $data = DB::table('categories')
    ...
    {
        $data = DB::table('podcasts')->where('status', 1)
            ->latest('podcast_id', 5)
            ->get();
    ...
    function showTipsEnergy($energy_id, $sub_energy_id)
    {
        $data['tips'] = DB::table('tips')
            ->where('energy_id', $energy_id)
            ->where('sub_energy_id', $sub_energy_id)
    ...
    function submitResetPasswordForm(Request $request)
    {
        ...
        // dd('Your password has been changed!');
